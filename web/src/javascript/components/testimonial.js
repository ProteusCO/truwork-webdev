jQuery(function($){
  ...
  $(".l-testimonial .scrollpane .clear-float").remove();
  
  $('.l-testimonial .test-slides').each(function(){
    var $con = $(this);
    ...
    var $slides = $con.find('.testimonial');
    var curSlideIdx = 0;
    ...
    function setupSlides() {
      ...
      $nav.on('click', '.navi.next', function(event){
        nextSlide("left");       
      });   
      
      $nav.on('click', '.navi.prev', function(event){
        nextSlide("right");       
      }); 
